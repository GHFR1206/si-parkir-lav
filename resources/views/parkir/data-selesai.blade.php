<x-app-layout selesai="active" header="Data Kendaraan Selesai">
  ...
  <div class="row d-flex justify-content-end">
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-success">
        ...
        <a href="{{ route('home') }}" class="small-box-footer">Info lanjut <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-secondary">
        ...
        <a href="#kendaraan_selesai" class="small-box-footer">Info lanjut <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
  </div>
